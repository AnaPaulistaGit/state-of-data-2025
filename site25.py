...
Original file is located at
    https://colab.research.google.com/drive/1pCLTRF_eytZoFiMDQ7uEZzQPdNjZJ5Xy
"""
...
with st.container():
    ...
    #st.title("Titulo")
    st.write('A calculadora da satisfaçao verifica a satisfaçao dos colaboradores na Area de dados. Sua base de dados foi atualizada para refletir o resultado da pesquisa em 2025.')
    st.write("Criado por [Alan Felipe](https://www.linkedin.com/in/alanxfelipe/)")
    st.write('Atualizada por [Ana Claudia Carvalho](https://www.linkedin.com/in/ana-carvalho-7b906b240/')
...
with st.container():
    ...
    if calcular:
        ...
        if classificacao == 1:
            ...
            satisfacao = 'A probabilidade é que este colaborador esteja Insatisfeito'
