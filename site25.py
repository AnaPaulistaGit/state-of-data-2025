...
modelo = joblib.load('classificar_satisfacao25.pkl')
...
with st.container():
    ...
    #st.title("Titulo")    
    st.write("Ferramenta baseada no **State of Data 2025** para verificar a satisfação de colaboradores.")
    st.write("Criado por [Alan Felipe](https://www.linkedin.com/in/alanxfelipe/)")
    st.write("Atualizado por [Ana Carvalho](https://www.linkedin.com/in/alanxfelipe/)")
...
with st.container():
    ...
    if calcular:
        ...
        if classificacao == 1:
            ...
            satisfacao = '⚠️ A probabilidade é que este colaborador esteja Insatisfeito'
